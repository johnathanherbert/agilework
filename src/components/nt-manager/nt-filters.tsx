    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <Card className="relative overflow-hidden border-gray-200/50 dark:border-gray-700/50 shadow-lg bg-gradient-to-br from-white via-gray-50/30 to-white dark:from-gray-900 dark:via-gray-900/50 dark:to-gray-900 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-red-50/50 dark:hover:bg-red-900/10 transition-colors duration-150 group cursor-pointer">
            <Checkbox
              id="status-pending"
            ...
            >
              <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center shadow-md">
          ...
          <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-green-50/50 dark:hover:bg-green-900/10 transition-colors duration-150 group cursor-pointer">
            <Checkbox
              id="status-paid"
          ...
          <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-amber-50/50 dark:hover:bg-amber-900/10 transition-colors duration-150 group cursor-pointer">
            <Checkbox
              id="status-partial"
      ...
      <Card className="relative overflow-hidden border-gray-200/50 dark:border-gray-700/50 shadow-md bg-gradient-to-br from-white via-gray-50/30 to-white dark:from-gray-900 dark:via-gray-900/50 dark:to-gray-900">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Calendar className="absolute left-3 top-1/2 h-4 w-4 text-blue-600 dark:text-blue-400 -translate-y-1/2" />
                <Input 
                  id="date-to"
                  type="date"
                  className="pl-9 border-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 transition-all duration-200 font-medium"
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger className="border-gray-300 dark:border-gray-600 hover:border-purple-500 dark:hover:border-purple-400 transition-colors duration-150 font-medium">
              ...
              <SelectContent className="border-gray-300 dark:border-gray-600">
                ...
                <SelectItem value="1" className="font-medium">1º Turno (07:20-15:50)</SelectItem>
                <SelectItem value="2" className="font-medium">2º Turno (15:50-23:00)</SelectItem>
                <SelectItem value="3" className="font-medium">3º Turno (23:00-07:20)</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </CardContent>
      ...
      <Card className="relative overflow-hidden border-gray-200/50 dark:border-gray-700/50 shadow-md bg-gradient-to-br from-white via-gray-50/30 to-white dark:from-gray-900 dark:via-gray-900/50 dark:to-gray-900">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-3 rounded-xl hover:bg-amber-50/50 dark:hover:bg-amber-900/10 transition-colors duration-150 border border-transparent group">
          ...
          <div className="flex items-center justify-between p-3 rounded-xl hover:bg-blue-50/50 dark:hover:bg-blue-900/10 transition-colors duration-150 border border-transparent group">
          ...
          <div className="flex items-center justify-between p-3 rounded-xl hover:bg-purple-50/50 dark:hover:bg-purple-900/10 transition-colors duration-150 border border-transparent group">
          ...
          <div className="pt-2">
            <Button
              variant="outline"
              size="sm"
              className="w-full hover:bg-red-50/50 dark:hover:bg-red-900/20 transition-colors duration-150 border-2 border-gray-300 dark:border-gray-600 hover:border-red-400 dark:hover:border-red-500 font-bold group"
              onClick={resetFilters}
            >
              <FilterX className="h-4 w-4 mr-2 relative z-10 text-red-600 dark:text-red-400" />
